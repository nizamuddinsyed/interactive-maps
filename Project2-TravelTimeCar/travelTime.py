...
travel_time_list = [["ALTONA", "WANDSBEK", "1 hour"],
                    ["ALTONA", "HARBURG", "3 hours"],
                    ["NORD", "HARBURG", "1 hours"],
                    ["WANDSBEK", "HARBURG", "1 hours"],
                    ["BERGEDORF", "HARBURG", "1 hours"],
                    ["WANDSBEK", "BERGEDORF", "1 hours"],
                    ["WANDSBEK", "ALTONA", "1 hours"],
                    ["EIMSBÜTTEL", "ALTONA", "1 hours"],
 ...
 image.
    ...
    if hands:
        ...
        if len(hands) == 2:
            ...
            cv2.circle(imgWarped, warped_point2, 30, (255, 0, 255), cv2.FILLED)
    ...
    if isinstance(warped_point, list):
        ...
        if len(check) == 2:
            ...
            for travel_time in travel_time_list:
                if check[0] in travel_time and check[1] in travel_time:
                    cvzone.putTextRect(imgOverlay, travel_time[1] + " to " + travel_time[0], (0, 100), scale=8,
                                       thickness=5)
                    cvzone.putTextRect(imgOverlay, travel_time[2], (0, 200), scale=8, thickness=5)
    else:
...
while True:
    ...
    # cv2.imshow("Output Image", imgOverlay)
